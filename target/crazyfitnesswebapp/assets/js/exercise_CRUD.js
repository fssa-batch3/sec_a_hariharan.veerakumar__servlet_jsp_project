...
// filtering top product
  for (let i = 0; i < productAppend("fullbody").length; i++) {
    fullbody_card.push(productAppend("fullbody")[i]);
  }
...
// calling the function
  if(admin_email == "hari@gmail.com"){
    createAdminCard(fullbody_card, ".sec-1")
  }
else{
    createCard(fullbody_card, ".sec-1")
}
