...
// filtering top product
  for (let i = 0; i < productAppend("shoulder").length; i++) {
    shoulder_card.push(productAppend("shoulder")[i]);
  }
...
function createCard(ar,selector) {
  ...
  // calling the function
    if(admin_email == "hari@gmail.com"){
      createAdminCard(shoulder_card, ".sec-1")
    }
  else{
      createCard(shoulder_card, ".sec-1")
  }
